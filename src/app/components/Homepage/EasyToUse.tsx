...
export default function EasyToUse() {
  return (
    <div id="easy-to-use" className="min-h-screen max-md:justify-center container flex flex-col md:flex-row-reverse items-center gap-4 py-16">
      <div className="md:w-1/2 flex justify-center items-center">
        <GiMagicBroom className="text-[125px] md:text-[250px] text-[#ffc107]" />
      </div>
